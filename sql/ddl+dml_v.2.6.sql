...
-- 더미데이터 삽입
INSERT INTO `member`
(member_role, member_id, member_pw, member_name, member_birth, member_phone, member_status, member_active, member_at, member_level, report_count)
VALUES
    ('ADMIN', 'admin01', 'adminpw!', '관리자', '1988-10-10', '010-1111-1111', 'normal', TRUE, '2025-01-05',NULL, 0),
    ('USER', 'soju_love', 'drinkpw1!', '박철수', '1995-07-07', '010-2222-2222', 'normal', TRUE, '2025-03-11', 200, 0),
    ('USER', 'beer_queen', 'beerpw2!', '김민지', '1998-11-23', '010-3333-3333', 'suspended', FALSE, '2025-04-02', 300, 0),
    ('USER', 'wine_master', 'winepw3!', '최영희', '1990-02-17', '010-4444-4444', 'normal', TRUE, '2025-05-20', 220, 0),
    ('USER', 'makgeolli', 'makpw4!', '정우성', '1993-12-30', '010-5555-5555', 'normal', TRUE, '2025-06-01', 60, 0),
    ('USER', 'cocktail_girl', 'cockpw5!', '한지민', '2000-09-09', '010-6666-6666', 'normal', TRUE, '2025-07-18', 50, 0),
    ('USER', 'sake_lover', 'sakpw6!', '오다유키', '1994-01-25', '010-7777-7777', 'normal', TRUE, '2025-08-03', 340, 0),
    ('USER', 'champagne_boy', 'champpw7!', '박상혁', '1992-04-19', '010-8888-8888', 'normal', TRUE, '2025-08-25', 200, 0),
    ('USER', 'highballer', 'highpw8!', '이진우', '1999-07-15', '010-9999-9999', 'normal', TRUE, '2025-09-01', 50, 0),
    ('USER', 'vodka_star', 'vodkapw9!', '안지수', '1997-12-12', '010-1010-1010', 'normal', TRUE, '2025-09-05', 50, 0),
    ('USER', 'gin_tonic', 'ginpw10!', '서민호', '1996-06-30', '010-1111-2222', 'normal', TRUE, '2025-09-07', 50, 0),
    ('USER', 'whisky_time', 'whiskypw11!', '김성훈', '1989-08-21', '010-2222-3333', 'withdrawn', FALSE, '2025-09-10', 500, 0),
    ('USER', 'rum_rider', 'rumpw12!', '홍길동', '1991-09-15', '010-3333-4444', 'normal', TRUE, '2025-09-11', 50, 0),
    ('USER', 'tequila99', 'teqpw13!', '최다혜', '1998-05-22', '010-4444-5555', 'normal', TRUE, '2025-09-12', 60, 0),
    ('USER', 'soju_kim', 'sojupw14!', '김철민', '1995-11-30', '010-5555-6666', 'normal', TRUE, '2025-09-13',340, 0),
    ('USER', 'beer_lee', 'beerpw15!', '이수진', '1993-03-18', '010-6666-7777', 'suspended', FALSE, '2025-09-14', 200, 0),
    ('USER', 'wine_park', 'winepw16!', '박지영', '1990-01-07', '010-7777-8888', 'normal', TRUE, '2025-09-15', 200, 0),
    ('ADMIN', 'admin02', 'adminpw2!', '서관리', '1985-06-05', '010-8888-9999', 'normal', TRUE, '2025-09-16', NULL, 0),
    ('USER', 'bbq_master', 'pw1!', '이서준', '1994-02-14', '010-1212-1212', 'normal', TRUE, '2025-09-16', 150, 0),
    ('USER', 'sool_scholar', 'pw2!', '김하늘', '1997-03-01', '010-1313-1313', 'normal', TRUE, '2025-09-16', 140, 0),
    ('USER', 'wine_beginner', 'pw3!', '최다연', '2001-09-09', '010-1414-1414', 'normal', TRUE, '2025-09-17', 200, 0),
    ('USER', 'beer_coder', 'pw4!', '박도윤', '1996-05-22', '010-1515-1515', 'normal', TRUE, '2025-09-17', 340, 0),
    ('USER', 'mak_fan', 'pw5!', '정윤아', '1999-08-30', '010-1616-1616', 'normal', TRUE, '2025-09-17', 340, 0),
    ('USER', 'high_holic', 'pw6!', '오세준', '1995-12-02', '010-1717-1717', 'normal', TRUE, '2025-09-18', 200, 0),
    ('USER', 'sake_trip', 'pw7!', '장유나', '1998-01-28', '010-1818-1818', 'normal', TRUE, '2025-09-18', 340, 0),
    ('USER', 'wine_note', 'pw8!', '신태훈', '1992-06-06', '010-1919-1919', 'normal', TRUE, '2025-09-18', 700, 0),
    ('USER', 'beer_runner', 'pw9!', '한유진', '1997-11-11', '010-2020-2020', 'normal', TRUE, '2025-09-19', 200, 0),
    ('USER', 'soju_writer', 'pw10!', '노수현', '1993-07-17', '010-2121-2121', 'normal', TRUE, '2025-09-19', 800, 0);
